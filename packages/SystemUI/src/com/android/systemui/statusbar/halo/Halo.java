...
public class Halo extends FrameLayout implements Ticker.TickerCallback {
    ...
    public Halo(Context context, AttributeSet attrs, int defStyle) {
        ...
        mPaintHolo.setColor(0xffffffff);
    ...
    private void updateHaloColors(){
        ...
        if(mEffect.mEnableCustomColor) {
           mEffect.setHaloCircleColor(
                    Settings.System.getInt(mContext.getContentResolver(), Settings.System.HALO_CIRCLE_COLOR, 0xffffffff));
           ...
           mPaintHolo.setColor(
                    Settings.System.getInt(mContext.getContentResolver(), Settings.System.HALO_EFFECT_COLOR, 0xffffffff));
           mNotifTitleColor =
